...
Para la implementación tanto del del generador de biblioteca sAPI como de las clases que definen el modelo se utilizó el lenguaje \emph{Javascrip} [] y el entorno de ejecución \emph{NodeJS} []. El motivo principal de esta decisión es permitir en un futuro realizar la definición de plataformas y generación de código desde una plataforma web. Estas herramientas permiten generar aplicaciones de escritorio, web o móviles con mínimos esfuerzos.
