...
\supervisor{MSc. Ing. Félix Gustavo E. Safar.} % El nombre del director, se usa en la carátula y se puede usar el cualquier lugar del documento con el comando \supname
...
\juradoUNO{Dr. Ing. Pablo M. Gómez (UBA)} % Nombre y pertenencia del un jurado se usa en la carátula y se puede usar el cualquier lugar del documento con el comando \jur1name
\juradoDOS{Mg. Ing. Pablo O. Ridolfi (UTN FRBA)} % Nombre y pertenencia del un jurado se usa en la carátula y se puede usar el cualquier lugar del documento con el comando \jur2name
...
%\include{Chapters/IntroGral/ContextoYJustificacion}
...
\input{Chapters/Diseno/ModulesTypes}

\input{Chapters/Diseno/ModelBoard}
\input{Chapters/Diseno/ModelSoc}
...
\input{Chapters/Implementacion/CodeGeneration}
\input{Chapters/Implementacion/Codemplementation}

\input{Chapters/Implementacion/LibExamples}

\input{Chapters/Implementacion/DocYDif}

% Ensayos y Resultados
\chapter{Ensayos y Resultados}
\label{ChapterEnsayosYResultados}

\input{Chapters/EnsayosYResultados/Chapter4}
